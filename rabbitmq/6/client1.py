...
class Sender():
    ...
    def call(self, number:int):
        ...
        send.ch.basic_publish(exchange='', routing_key='rpc_queue', body=str(number),
                         properties=pika.BasicProperties(headers={'name_client':'client_one'}, reply_to=self.qname,
